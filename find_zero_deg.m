...
f_left  = fit(([115 120 125 130 135 140 145] - 180).', ...
              [f115.b1 f120.b1 f125.b1 f130.b1 ...
               f135.b1 f140.b1 f145.b1].', ...
              'poly1');
f_right = fit(([215 220 225 230 235 240 245] - 180).', ...
...
intercept_numerator   = f_right.p2 - f_left.p2;
intercept_denominator = f_left.p1 - f_right.p1;
...
if draw_fit
    ...
    fill([-69 69 69 -69], ...
         [conf_left(1, 1) * -69 + conf_left(1, 2), ...
          conf_left(1, 1) *  69 + conf_left(1, 2), ...
          conf_left(2, 1) *  69 + conf_left(2, 2), ...
          conf_left(2, 1) * -69 + conf_left(2, 2)], ...
         'c', 'edgecolor', 'w');
    fill([-69 69 69 -69], ...
         [conf_right(1, 1) * -69 + conf_right(1, 2), ...
          conf_right(1, 1) *  69 + conf_right(1, 2), ...
          conf_right(2, 1) *  69 + conf_right(2, 2), ...
          conf_right(2, 1) * -69 + conf_right(2, 2)], ...
         'c', 'edgecolor', 'w');
